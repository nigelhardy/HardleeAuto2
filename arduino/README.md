...
All projects require `credentials.h` with MQTT credentials. This file is **not** committed to git (see `.gitignore`).
...
- Check your password manager for the MQTT credentials
